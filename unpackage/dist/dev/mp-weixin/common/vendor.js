...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"pet-life","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 13:
/*!***************************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/store/share.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!***************************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/store/index.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!***************************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/common/http.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getToken = getToken;var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
module.exports = {
  ...
  post: function post(url, data) {var xAuthToken = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  ...
  get: function get(url, data) {var xAuthToken = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    url = _config.default + url;
    var header = {
...
/***/ 16:
/*!*****************************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/common/config.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 23:
/*!**************************************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/components/amap-wx.130.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 234:
/*!**************************************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/static/dataJson/city.json ***!
  \**************************************************************************/
...
/***/ 24:
/*!***************************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/api/backend.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

module.exports = {
  // 获取用户信息
  login: function login(param) {
    return _http.default.post('/user/login', param);
  },
  // 获取用户手机号
  getPhoneNumber: function getPhoneNumber(param) {
    return _http.default.post('/user/getPhoneNumber', param);
  },
  // 发布宠物领养
  addPetAdopt: function addPetAdopt(param) {
    return _http.default.post('/adopt/add', param);
  },
  // 查询宠物领养列表
  queryPetAdopts: function queryPetAdopts(param) {
    return _http.default.post('/adopt/queryList', param);
  },
  // 上传图片
  uploadFile: function uploadFile(param) {
    return _http.default.uploadFile('/file/uploadPic', param);
  },
  // 删除图片
  deletePic: function deletePic(param) {
    return _http.default.get('/file/deletePic', param);
  },
  // 查询宠物领养信息
  getPetAdopt: function getPetAdopt(param) {
    return _http.default.get("/adopt/getById", param);
  },
  // 发布寻宠信息
  addPetFind: function addPetFind(param) {
    return _http.default.post('/petFind/add', param);
  },
  // 查询寻宠列表
  queryPetFinds: function queryPetFinds(param) {
    return _http.default.post('/petFind/queryList', param);
  },
  // 查询寻宠信息
  getPetFind: function getPetFind(param) {
    return _http.default.get("/petFind/getById", param);
  },
  // 新增宠物圈
  addPetCircle: function addPetCircle(param) {
    return _http.default.post('/petCircle/add', param);
  },
  // 查询宠物圈列表
  queryPetCircles: function queryPetCircles(param) {
    return _http.default.post('/petCircle/queryList', param);
  },
  // 查询宠物圈
  getPetcircle: function getPetcircle(param) {
    return _http.default.get('/petCircle/getById', param);
  },
  // 查询宠物科普列表
  queryPetCyclopedias: function queryPetCyclopedias(param) {
    return _http.default.post('/petCyclopedia/queryList', param);
  },
  // 查询宠物科普
  getPetCyclopedia: function getPetCyclopedia(param) {
    return _http.default.get('/petCyclopedia/getById', param);
  },
  // 查询积分
  getCredits: function getCredits(param) {
    return _http.default.get('/credits/getCredits', param);
  },
  // 更新积分/签到天数
  updateCredits: function updateCredits(param) {
    return _http.default.get('/credits/updateCredits', param);
  },
  // 查询用户信息
  getUserInfo: function getUserInfo(param) {
    return _http.default.get('/user/getUserInfo', param);
  },
  // 查询领养/寻宠总数
  queryPetCount: function queryPetCount(param) {
    return _http.default.get('/adopt/queryCount', param);
  },
  // 新增评论
  addComment: function addComment(param) {
    return _http.default.post('/comment/addComment', param);
  },
  // 查询评论列表 By FromId
  queryComments: function queryComments(param) {
    return _http.default.get('/comment/queryComments', param);
  },
  // 查询评论总数 By FromId
  queryCommentCount: function queryCommentCount(param) {
    return _http.default.get('/comment/queryCount', param);
  },
  // 点赞
  addLove: function addLove(param) {
    return _http.default.get('/comment/addLove', param);
  },
  // 取消点赞
  cutLove: function cutLove(param) {
    return _http.default.get('/comment/cutLove', param);
  },
  // 删除评论
  deleteComment: function deleteComment(param) {
    return _http.default.get('/comment/deleteComment', param);
  },
  // 查询文章列表
  queryArticles: function queryArticles(param) {
    return _http.default.post('/article/queryArticles', param);
  },
  // 新增聊天消息
  addChat: function addChat(param) {
    return _http.default.post('/chat/add', param);
  },
  // 查询消息数量
  queryChatCount: function queryChatCount(param) {
    return _http.default.get('/chat/queryCount', param);
  },
  // 查询聊天内容
  queryChatContent: function queryChatContent(param) {
    return _http.default.get('/chat/queryChatContent', param);
  },
  // 查询未读消息总数
  queryUnreadTotal: function queryUnreadTotal(param) {
    return _http.default.get('/chat/queryUnreadTotal', param);
  },
  // 添加用户关注
  addUserFollow: function addUserFollow(param) {
    return _http.default.post('/userFollow/addUserFollow', param);
  },
  // 取消关注
  unUserFollow: function unUserFollow(param) {
    return _http.default.post('/userFollow/unUserFollow', param);
  },
  // 查询是否关注
  isFollow: function isFollow(param) {
    return _http.default.get('/userFollow/isFollow', param);
  },
  // 查询用户关注列表
  queryUserFollows: function queryUserFollows(param) {
    return _http.default.get('/userFollow/queryUserFollows', param);
  },
  // 手机号登录
  phoneLogin: function phoneLogin(param) {
    return _http.default.get('/user/phoneLogin', param);
  },
  // getFlag
  getFlag: function getFlag() {
    return _http.default.get('/index/getFlag');
  },
  // 查询题目
  getAnswer: function getAnswer(param) {
    return _http.default.get('/answer/getAnswerPrize', param);
  },
  // 用户答题 添加记录
  addAnswerRecord: function addAnswerRecord(param) {
    return _http.default.post('/answer/addAnswerRecord', param);
  },
  // 今日是否已答题
  isFinishToday: function isFinishToday(param) {
    return _http.default.get('/answer/isFinishToday', param);
  },
  // 查询答题记录
  queryAnswerRecords: function queryAnswerRecords(param) {
    return _http.default.post('/answer/queryAnswerRecords', param);
  },
  // 添加收藏
  addCollect: function addCollect(param) {
    return _http.default.post('/collect/addCollect', param);
  },
  // 取消收藏
  removeCollect: function removeCollect(param) {
    return _http.default.post('/collect/removeCollect', param);
  },
  // 是否收藏
  isCollect: function isCollect(param) {
    return _http.default.post('/collect/isCollect', param);
  },
  // 查询收藏
  queryCollect: function queryCollect(param) {
    return _http.default.post('/collect/queryCollect', param);
  } };
...
/***/ 5:
/*!***********************************************************!*\
  !*** E:/Private Project/pet-life/pet-life-xcx/pages.json ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
